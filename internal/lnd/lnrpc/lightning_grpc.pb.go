...
func (c *lightningClient) SubscribeInvoices(ctx context.Context, in *InvoiceSubscription, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Invoice], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Lightning_ServiceDesc.Streams[6], Lightning_SubscribeInvoices_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SubscribeChannelGraph(ctx context.Context, in *GraphTopologySubscription, opts ...grpc.CallOption) (grpc.ServerStreamingClient[GraphTopologyUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Lightning_ServiceDesc.Streams[7], Lightning_SubscribeChannelGraph_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SubscribeChannelBackups(ctx context.Context, in *ChannelBackupSubscription, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ChanBackupSnapshot], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Lightning_ServiceDesc.Streams[8], Lightning_SubscribeChannelBackups_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) RegisterRPCMiddleware(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[RPCMiddlewareResponse, RPCMiddlewareRequest], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Lightning_ServiceDesc.Streams[9], Lightning_RegisterRPCMiddleware_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SubscribeCustomMessages(ctx context.Context, in *SubscribeCustomMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[CustomMessage], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Lightning_ServiceDesc.Streams[10], Lightning_SubscribeCustomMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
func (c *lightningClient) SubscribeOnionMessages(ctx context.Context, in *SubscribeOnionMessagesRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[OnionMessageUpdate], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Lightning_ServiceDesc.Streams[11], Lightning_SubscribeOnionMessages_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
